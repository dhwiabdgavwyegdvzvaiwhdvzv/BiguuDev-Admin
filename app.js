...
bottom: 20px;
right: 20px;
background: ${type === "error" ? "#ff4d6d" : "#0d3b2a"};
color: ${type === "error" ? "#fff" : "#2bfba5"};
border: 1px solid ${type === "error" ? "rgba(255,255,255,0.25)" : "rgba(43,251,165,0.35)"};
...
${u.lock ? "Locked" : u.risk ? "At Risk" : u.status === "active" ? "Active" : "Disabled"}
</div>
<div class="user-meta">
...
${u.riskCount > 0 ? `<div class="user-badge">${u.riskCount} risk events</div>` : ""}
...
document.getElementById("detail-lock-badge").classList.toggle("danger", !!s.lock);
document.getElementById("detail-risk-badge").textContent = s.risk ? "At Risk" : "Clean";
document.getElementById("detail-risk-badge").classList.toggle("danger", !!s.risk);
...
<div class="script-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path><polyline points="14 2 14 8 20 8"></polyline></svg></div>
